...
Call log:
  - waiting for locator('button:has-text("שלח")')
    - locator resolved to <button type="submit" class="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 disabled:bg-gray-400 transition font-medium">שלח</button>
